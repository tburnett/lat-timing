...
class GammaData(DocPublisher): 
    ...
    def data_summary(self):
        ...
        2. **Binned photons**: The binning used here is performed by `pointlike`. Energies are reduced to 4/decade 
        bands according to energy and event type, front or back. Thus there are 32 such bands from 100 MeV to 1 TeV.
